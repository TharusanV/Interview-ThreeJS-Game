...
export function InterogrationRoom({ rotation = [0, 0, 0], position = [0, 0.1, 0], scale = 1, ...props }) {
  ...
  return (
    <group rotation={rotation} position={position} scale={scale} {...props} dispose={null}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.Chair001.geometry} material={whiteMaterial} position={[0.044, 0, -0.451]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={0.004} />
      ...
      <mesh castShadow receiveShadow geometry={nodes.Window.geometry} material={whiteMaterial} position={[1.547, 1.678, 0.795]} rotation={[Math.PI / 2, 0, Math.PI]} scale={0.01} />
      ...
      <mesh castShadow receiveShadow geometry={nodes.Handcuffs.geometry} material={whiteMaterial} position={[0.341, 0.814, -0.074]} rotation={[Math.PI / 2, 0, -2.499]} scale={0.01} />
